module Test.Generated.Main1161082428 exposing (main)
...
main =
    ...
    RippleCarryAdderTests.andGateTests] ]
        |> Test.concat
        |> Test.Runner.Node.run { runs = Nothing, report = (ConsoleReport UseColor), seed = 334728219311608, processes = 4, paths = ["/c/dev/elmsandbox/tests/FuzzTests.elm"]}