module Test.Generated.Main4100400258 exposing (main)
...
main =
    ...
    RippleCarryAdderTests.andGateTests] ]
        |> Test.concat
        |> Test.Runner.Node.run { runs = Nothing, report = (ConsoleReport UseColor), seed = 39828362227249, processes = 4, paths = ["/c/dev/elmsandbox/tests/RippleCarryAdderTests.elm"]}