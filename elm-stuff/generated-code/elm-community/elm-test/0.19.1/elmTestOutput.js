...
var $author$project$RippleCarryAdderTests$andGateTests = A2(
	...
	_List_fromArray(
		[
			...
			A2(
			$elm_explorations$test$Test$test,
			'output is 0 when the first input is 0',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
			...
			A2(
			$elm_explorations$test$Test$test,
			'output is 0 when the second input is 0',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
...
var $author$project$RippleCarryAdderTests$fullAdderTests = A2(
	...
	_List_fromArray(
		[
			...
			A2(
			$elm_explorations$test$Test$describe,
			'when the 1st input is 0',
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$describe,
					'and the 2nd input is 1',
					_List_fromArray(
						[
							A2(
							$elm_explorations$test$Test$describe,
			...
			A2(
			$elm_explorations$test$Test$describe,
			'when the 1st input is 1',
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$describe,
					'and the 2nd input is 0',
					_List_fromArray(
						[
							A2(
							$elm_explorations$test$Test$describe,
...
var $author$project$RippleCarryAdderTests$halfAdderTests = A2(
	...
	_List_fromArray(
		[
			...
			A2(
			$elm_explorations$test$Test$test,
			'sum is 1 and carry-out is 0 when the 1st input is 0 and the 2nd input is 1',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					{carry: 0, sum: 1},
			...
			A2(
			$elm_explorations$test$Test$test,
			'sum is 1 and carry-out is 0 when the 1st input is 1 and the 2nd input is 0',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					{carry: 0, sum: 1},
...
var $author$project$RippleCarryAdderTests$orGateTests = A2(
	...
	_List_fromArray(
		[
			...
			A2(
			$elm_explorations$test$Test$test,
			'output is 1 when the first input is 0',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					1,
			...
			A2(
			$elm_explorations$test$Test$test,
			'output is 1 when the second input is 0',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					1,
...
var $author$project$Test$Generated$Main1161082428$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/c/dev/elmsandbox/tests/FuzzTests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 334728219311608
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'FuzzTests',
				_List_fromArray(
					[$author$project$FuzzTests$addOneTests, $author$project$FuzzTests$addTests])),
				A2(
				$elm_explorations$test$Test$describe,
				'RippleCarryAdderTests',
				_List_fromArray(
					[$author$project$RippleCarryAdderTests$orGateTests, $author$project$RippleCarryAdderTests$inverterTests, $author$project$RippleCarryAdderTests$halfAdderTests, $author$project$RippleCarryAdderTests$fullAdderTests, $author$project$RippleCarryAdderTests$rippleCarryAdderTests, $author$project$RippleCarryAdderTests$andGateTests]))
			])));
_Platform_export({'Test':{'Generated':{'Main1161082428':{'init':$author$project$Test$Generated$Main1161082428$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-2848.sock";
